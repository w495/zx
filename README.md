...
* [Ru: man console_codes](https://www.opennet.ru/man.shtml?topic=console_codes);
...
* [color.sh](https://github.com/Neved4/color.sh)
: Test terminal colors with POSIX shells.

* [posix-colors](https://github.com/MidnightRocket/posix-colors)
